...
class Concert extends Performance {
  ...
  info() {
    console.log(`Гурт ${this.band.name} виступить в ${this.location} ${this.date.toLocaleDateString()}, ціна квитка ${this.#ticketPrice}`);
  }
...
class LeadSinger extends Vocalist {
  ...
  // Створюємо конструкто р з двома вхідними параметрами: name, band
  // super(name, band);
}
